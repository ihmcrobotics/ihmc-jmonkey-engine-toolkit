...
public class FocusBasedCameraController implements TrackingDollyCameraController, KeyListener, MouseListener, Mouse3DListener, SelectedListener
{
   ...
   {
      FocusBasedCameraController classicCameraController = new FocusBasedCameraController(graphics3dAdapter,
                                                                                          viewportAdapter,
   ...
   public FocusBasedCameraController(Graphics3DAdapter graphics3dAdapter, ViewportAdapter viewportAdapter,
                                     CameraTrackingAndDollyPositionHolder cameraTrackAndDollyVariablesHolder)
   {
